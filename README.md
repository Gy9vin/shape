...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.3-8ECA43?style=flat-square" alt="версия"></a>
...
```
  ...
  ────────────────────────────────────────────────────────────────────────────
   IP                      сейчас    отдача  мин.средн   доля лимита
 ...
 ⊘ 89.253.46.46               1.0       0.0        4.3   █▎··········  10%
  ────────────────────────────────────────────────────────────────────────────
   показано 20 из 58   ▪ держит больше 30 с   ⊘ ограничен
```
...
**Значок слева:** ▪ адрес держит нагрузку дольше 30 секунд, ⊘ адрес уже
ограничен. Спарклайн в шапке — канал за последнюю минуту.
