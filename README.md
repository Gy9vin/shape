...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.8-8ECA43?style=flat-square" alt="версия"></a>
...
Одинаковый отпечаток означает одинаковую политику. Считается он от скорости,
портов и настроек автоограничения — то есть от того, что должно совпадать на
всех нодах.
...
Одна строка в ответе — весь парк настроен одинаково. Две и больше — видно
сразу, сколько нод и с каким отпечатком.
