...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.16-8ECA43?style=flat-square" alt="версия"></a>
...
```
 ...
 ▪ 109.248.47.99            10.1     0.1    140     3.1 12 мин  ████████████ 101%
 ▪ 91.78.0.72                9.8     0.2    150     9.6 44 мин  ███████████▉  98%
   91.79.7.124               6.4     0.2    130     1.1      —  ███████▊····  64%
 ✓ 203.0.113.40              5.1     0.4    160     4.8  5 мин  ██████▏·····  51%
...
5.6.7.8
…
…и ещё 417. Полный список — файлом следом.
```
...
В сообщении Telegram помещается 4096 символов, и полторы сотни человек с их
адресами туда не влезают — длинный отчёт уходит **файлом**, короткий остаётся
сообщением. Тот же приём в оповещении о раздаче: первые двадцать адресов в
тексте, полный список вложением.
